...
public class SpreadsAdapter extends RecyclerView.Adapter<SpreadsViewHolder> {

    ArrayList<ModelClass> modelClassArrayList;
    BuyItemClickListner listner;

    public SpreadsAdapter(ArrayList<ModelClass> modelClassArrayList, BuyItemClickListner listner) {
    ...
    @NonNull
    @Override
    public SpreadsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.chicken_item_layout,parent,false);
        return new SpreadsViewHolder(view,listner);
    }

    @Override
    public void onBindViewHolder(@NonNull  SpreadsViewHolder holder, int position) {
...
class SpreadsViewHolder extends RecyclerView.ViewHolder {
    ...
    public SpreadsViewHolder(@NonNull View itemView, BuyItemClickListner listner) {
        super(itemView);
        this.listner=listner;
        iniViews(itemView);
    }
