...
public class ReadyAdapter extends RecyclerView.Adapter<ReadyViewHolder> {

    ArrayList<ModelClass> modelClassArrayList;
    BuyItemClickListner listner;

    public ReadyAdapter(ArrayList<ModelClass> modelClassArrayList,BuyItemClickListner listner) {
    ...
    public ReadyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ReadyViewHolder(view,listner);
    }

    @Override
    public void onBindViewHolder(@NonNull  ReadyViewHolder holder, int position) {
...
class ReadyViewHolder extends RecyclerView.ViewHolder {
    ...
    public ReadyViewHolder(@NonNull View itemView,BuyItemClickListner listner) {
        super(itemView);
        this.listner=listner;
        iniViews(itemView);
    }
    ...
    public void setdata(ModelClass modelClass) { mBtnAddToCart.setOnClickListener(new View.OnClickListener() {
        @Override
