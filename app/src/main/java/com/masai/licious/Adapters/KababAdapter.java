...
public class KababAdapter extends RecyclerView.Adapter<KababViewHolder> {

    ArrayList<ModelClass> modelClassArrayList;
    BuyItemClickListner listner;

    public KababAdapter(ArrayList<ModelClass> modelClassArrayList,BuyItemClickListner listner) {
    ...
    @NonNull
    @Override
    public KababViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.chicken_item_layout,parent,false);
        return new KababViewHolder(view,listner);
    }

    @Override
    public void onBindViewHolder(@NonNull  KababViewHolder holder, int position) {
...
class KababViewHolder extends RecyclerView.ViewHolder {
    ...
    public KababViewHolder(@NonNull View itemView,BuyItemClickListner listner) {
        super(itemView);
        this.listner=listner;
        iniViews(itemView);
    }
