...
public class MuttonAdapter extends  RecyclerView.Adapter<MuttonViewHolder> {
    ...
    public MuttonAdapter(ArrayList<ModelClass> modelClassArrayList,BuyItemClickListner listner) {
    ...
    public MuttonViewHolder onCreateViewHolder(@NonNull  ViewGroup parent, int viewType) {
        ...
        return new MuttonViewHolder(view,listner);
    }
...
class MuttonViewHolder extends RecyclerView.ViewHolder {
    ...
    BuyItemClickListner listner;
    public MuttonViewHolder(@NonNull  View itemView, BuyItemClickListner listner) {
        super(itemView);
        this.listner=listner;
        iniViews(itemView);
    }
